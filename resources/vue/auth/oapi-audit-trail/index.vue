         ...
         <div class="container">
            <div class="row py-3">
               <div class="col-sm als">
                  <div class="font-weight-bolder h4">Daftar OApi Audit Trail</div>
               </div>
               <div class="col-sm als">
            ...
            <div class="py-2 table-responsive">
               <table class="table table-hover">
                  ...
                  <tr v-for="(audit_trail,i) in in_oapi_audit_trail.data" :key="i">
                     ...
                     <td class="px-3 align-middle small">{{audit_trail.get_app_name.app_name}}</td>
...
export default {
   ...
   methods: {
      loadPaginate(page = 1) {
         ...
         axios
            .get(this.$api_oapi_audit_trail + "?page=" + page)
            .then(respon => {
               this.in_oapi_audit_trail = respon.data.in_oapi_audit_trail;
            });
      },
      verify_permission() {
      ...
      pencarian() {
         ...
         axios
            .get(
               this.$api_oapi_audit_trail + "/pencarian?cari=" + this.cari_data
            )
            .then(respon => {
